...
class Train():
    ...
    def model(model_name,train_labels):
    ...
    def tune_train(bert_model,train_labels,train_dataloader):
        selected_model,cross_entropy,optimizer= Train.model(bert_model,train_labels)
    ...
    def save_trained(model_name:str,model_trained):
        ...
        if(model_name=="bert"):
            torch.save(model_trained, "model/bert")
        elif(model_name=="roberta"):
           torch.save(model_trained, "model/roberta")
